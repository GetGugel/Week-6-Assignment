...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        Rectangle Door2 = new Rectangle(360,360,80,300);
        Door2.setFill(Color.WHITE);
        Door2.setStroke(Color.BLACK);
        
        Rectangle Door3 = new Rectangle(510,380,80,300);
      ...
      //  Line ln3 = new Line(400,400,400,600);
        ...
        columnBallR3,columnBallL4,columnBallR4);
       ...
       Rectangle[] Steps = new Rectangle[StepL];  
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if(i==0)WindowsL1[i].setHeight(16);
            else WindowsL1[i].setHeight(32);
